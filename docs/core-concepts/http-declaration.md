...
| `proxies` | `#!python str | None | URL | Proxy` |   No, default: `#!python None`     |    Keyword     | The [proxies](https://www.python-httpx.org/advanced/#http-proxying) to use with every request. |
